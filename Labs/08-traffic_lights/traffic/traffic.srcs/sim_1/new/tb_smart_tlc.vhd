------------------------------------------------------------------------
--
-- Testbench fot smart traffic lights controller.
...
architecture testbench of tb_smart_tlc is
    ...
    signal s_sensor       : std_logic_vector(2 - 1 downto 0);
...
--        s_reset <= '0';
    ...
    begin
        ...
        -- Test sensor input 
        s_sensor <= "00"; wait for 1000 ns;
        s_sensor <= "01"; wait for 1000 ns;
        s_sensor <= "11"; wait for 1000 ns;
        s_sensor <= "10"; wait for 1000 ns;
        s_sensor <= "00"; wait for 1000 ns;
        s_sensor <= "11"; wait for 1000 ns;
        s_sensor <= "00"; wait for 1000 ns;
        s_sensor <= "11"; wait for 1000 ns;
