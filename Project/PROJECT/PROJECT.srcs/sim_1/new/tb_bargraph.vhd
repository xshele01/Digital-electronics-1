...
begin
    ...
    begin
        ...
        report "Test failed for input s_cm = 00000101" severity error;
        wait for 101700 ns;
        ...
        assert ((s_bar_o = "1111") and (s_rgb_o <= "100"))
        -- If false, then report an error
        report "Test failed for input s_cm = 00010100" severity error;
        wait for 101700 ns;
        ...
        -- If false, then report an error
        report "Test failed for input s_cm = 00100011" severity error;
        wait for 95900 ns;
        
		s_cm <= "10001100"; -- 140 cm
        wait for 30 ns;
