...
## Switches
set_property CLOCK_DEDICATED_ROUTE FALSE -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { sw_i[0] }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
set_property CLOCK_DEDICATED_ROUTE FALSE -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { sw_i[1] }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
...
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { echo_i[0] }]; #IO_L4N_T0_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { trig_o[0] }]; #IO_L6P_T0_15 Sch=ja[4]
#set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { ja[4] }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
#set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { ja[5] }]; #IO_L10P_T1_AD11P_15 Sch=ja[8]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { echo_i[1] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { trig_o[1] }]; #IO_25_15 Sch=ja[10]
...
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { pwm_o }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
